...
class QualcommKeywordSpeechDataloader(Sequence):
    def __init__(self, 
                 batch_size,
                 fs = 16000,
                 wav_dir='/datas/store162/syt/PhonMatchNet/DB/qualcomm_keyword_speech_dataset',
...
if __name__ == '__main__':
    dataloader = QualcommKeywordSpeechDataloader(2048, pkl='/datas/store162/syt/PhonMatchNet/DB/qualcomm_keyword_speech_dataset/qualcomm.pkl', features='g2p_embed')